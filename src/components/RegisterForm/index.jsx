    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          if (response.status === 201) {
            toast({
                size: 20,
                title: 'Successfully Registed, Now log-in!',
                status: 'success',
                duration: 15000,
                isClosable: true,
            });
    ...
    return (
        <Box className={styles.formContainer}>
            <form>
                ...
                <Text className={styles.account} as="h4">Already Registered?</Text>
                <Link to="/login">
                    <Text className={styles.register} as="h4">Log-in here</Text>
                </Link>
            </form>
        </Box>
    );
